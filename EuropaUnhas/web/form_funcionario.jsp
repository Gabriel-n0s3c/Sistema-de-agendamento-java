                            ...
                            <div>
                                ...
                                <section>
                                    ...
                                    <section>
                                        ...
                                        <fmt:parseDate value="${funcionario.dataNasc}" pattern="yyyy-MM-dd" var="parsedDate" />
                                    ...
                                    <section>
                                        ...
                                        <input type="text" name="cpf" id="cpf" class="form-control" maxlength="14" data-mask="000.000.000-00"  value="${funcionario.cpf}"/>
                                    </section>
                                    <section>
                                ...
                                <section>
                                    ...
                                    <a  href="funcionario.jsp" class="btn btn-success">
                                        Voltar
                                    </a>  
                                </section>
                            </div>
