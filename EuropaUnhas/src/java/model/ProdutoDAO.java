...
public class ProdutoDAO extends DataBaseDAO{
    ...
    public ArrayList<Produto> getListaProdutoEmFalta(){
        ArrayList<Produto> listaProd = new ArrayList<>();
        String sql="SELECT * FROM produto WHERE produto.quantidade <= 10";
        try{
            this.conectar();
            Statement stm = conn.createStatement();
            rs = stm.executeQuery(sql);
    ...
    public ArrayList<Produto> getQuantidadePorProduto(){
        ArrayList<Produto> listaProd = new ArrayList<>();
