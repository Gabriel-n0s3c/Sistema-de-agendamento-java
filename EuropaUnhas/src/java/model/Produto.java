...
public class Produto {
    ...
    public ArrayList<Produto> getListaProdutoEmFalta() throws Exception{
        ProdutoDAO dao = new ProdutoDAO();
        return dao.getListaProdutoEmFalta();
    }
    public ArrayList<Produto> getQuantidadePorProduto() throws Exception{
        ProdutoDAO dao = new ProdutoDAO();
        return dao.getQuantidadePorProduto();
    }
